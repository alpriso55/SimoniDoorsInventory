...
namespace SimoniDoorsInventory.ViewModels
{
    abstract public partial class GenericDetailsViewModel<TModel> : ViewModelBase where TModel : ObservableObject, new()
    {
        ...
        virtual protected async void OnSave()
        {
            ...
            {
                await DialogService.ShowAsync(result.Message, $"{result.Description} Διορθώστε το λάθος και ξαναπροσπαθήστε.");
            }
        }
        ...
        abstract protected Task<bool> DeleteItemAsync(TModel mode);
